...
/**
 * About AI Pro App - an original, honest brand story page.
    ...
    <>
      ...
      <section className="ab-hero" aria-labelledby="about-title">
        ...
        <div className="shell ab-hero-grid">
          <div className="rv">
            <p className="ab-eyebrow">About AI Pro App</p>
            <h1 id="about-title">
              Research that helps you <span className="grad">decide, not guess.</span>
            </h1>
            <p className="ab-lede">
              AI Pro App is an Australian platform that pairs <strong>AI-assisted market scanning</strong>
        ...
        <div className="shell">
          <div className="ab-story-grid">
            <div className="ab-story-img rv">
              ...
              <span className="tag">
                <svg viewBox="0 0 24 24" width="15" height="15" fill="none" aria-hidden="true">
                  <circle cx="12" cy="12" r="9" stroke="#0E7490" strokeWidth="2" />
                  <path d="M12 7v5l3 2" stroke="#0E7490" strokeWidth="2" strokeLinecap="round" />
                </svg>
            ...
            <div className="ab-story-copy rv">
              ...
              <p>
                AI Pro started with a simple observation: most people don&rsquo;t have a crypto
              ...
              <ul className="ab-tick">
                <li>
                  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
                    <circle cx="12" cy="12" r="10" fill="#06B6D4" opacity="0.18" />
                    <path d="M8 12.5l2.6 2.6L16 9.5" stroke="#0E7490" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
