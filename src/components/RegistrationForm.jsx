...
const OFFER_NAME = 'AI-Pro-App-Site';
...
export default function RegistrationForm() {
  ...
  const inputClass = (name) =>
    `w-full rounded-xl border bg-white px-4 py-3 text-sm text-ink shadow-[0_1px_2px_rgba(30,27,75,0.04)] transition placeholder:text-muted/60 focus:border-secondary focus:outline-none ${
