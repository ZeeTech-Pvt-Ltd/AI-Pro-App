...
export default function PhoneField({
  ...
  return (
    <div ref={rootRef} className="relative">
      <div
        className={`flex items-stretch overflow-hidden rounded-xl border bg-white shadow-[0_1px_2px_rgba(30,27,75,0.04)] transition focus-within:border-secondary ${
      ...
      >
        ...
        >
          <img
            ...
            height="15"
            loading="lazy"
            className="h-[15px] w-5 rounded-[2px] object-cover shadow-[0_0_0_1px_rgba(30,27,75,0.08)]"
            onError={(event) => {
              ...
              return (
                ...
                >
                  <img
                    ...
                    height="15"
                    loading="lazy"
                    className="h-[15px] w-5 shrink-0 rounded-[2px] object-cover shadow-[0_0_0_1px_rgba(30,27,75,0.08)]"
                    onError={(event) => {
                      event.currentTarget.style.visibility = 'hidden';
                    }}
                  />
