...
export const LEGAL_DOCS = {
  privacy: {
    ...
    intro:
      'This policy explains how AI Pro App collects, uses and protects your personal information, in line with the Australian Privacy Principles under the Privacy Act 1988 (Cth).',
    sections: [
      {
  ...
  cookie: {
    title: 'Cookie Policy',
    intro:
      'This policy explains what cookies are, how AI Pro App uses them and the choices available to you. It should be read together with our Privacy Policy.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'We may update this policy as the website and the services we rely on change. Any changes will be posted on this page. If you have questions about cookies or this policy, email us at support@ai-proapp.com.',
      },
    ],
  },
  terms: {
    ...
    intro:
      'These terms govern your use of the AI Pro App website and platform. By registering, you agree to be bound by them.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'AI Pro App provides market information, analytics tools, data visualisation and educational resources. Content is provided for general information and education only and should not be treated as a recommendation, offer or solicitation to buy or sell any financial product.',
      },
      {
  ...
  risk: {
    ...
    intro:
      'Please read this disclosure carefully before using AI Pro App.',
    sections: [
      {
      ...
      },
      {
        ...
        body: 'AI Pro App is not a financial adviser and does not hold an Australian financial services licence. We do not provide personal financial product advice, recommendations or portfolio management services. Any tools, charts or data are provided to support your own research.',
      },
      {
  ...
  disclaimer: {
    ...
    sections: [
      {
        heading: 'General information only',
        body: 'Content on AI Pro App (including articles, charts, data and AI-assisted summaries) is general in nature and is not personal financial advice. It does not take into account your personal objectives, financial situation or needs.',
      },
      {
        heading: 'No adviser relationship',
        body: 'AI Pro App is a research platform, not a financial adviser, and does not hold an Australian financial services licence. Nothing on this website is a recommendation, offer or solicitation to buy or sell any financial product, and we do not provide portfolio management services.',
      },
      {
